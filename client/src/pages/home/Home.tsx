    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container text-center max-w-4xl mx-auto px-4">
          <h2 className="text-4xl md:text-6xl font-bold mb-6 leading-tight text-center">
            <div className="block">Your Path to</div>
            <div className="inline-flex items-center justify-center whitespace-nowrap w-full gap-2">
              <HyperText
                text="Cybersecurity"
      ...
      <section
        id="mission"
        className="relative py-16 md:py-24 bg-gradient-to-b from-background via-card/30 to-background"
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div id="mission-card" className="flex flex-col">
              ...
              <GlowCard
                glowColor="teal"
                customSize={true}
                className="w-full bg-card/80 border-border/50 transition-all duration-300 hover:scale-105 hover:-translate-y-2 p-8 md:p-10 !grid-rows-1 flex-1"
              >
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-background via-card/30 to-background">
        <div className="container max-w-6xl mx-auto">
          ...
          <div className="relative flex size-full max-w-5xl mx-auto items-center justify-center overflow-hidden px-8 pb-16 pt-8 min-h-[500px]">
            <IconCloud iconSlugs={[
              "splunk",
              "kali",
              "metasploit",
